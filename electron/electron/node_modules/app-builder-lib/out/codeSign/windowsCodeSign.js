...
function getSignVendorPath() {
  ...
  return (0, _binDownload().getBinFromGithub)("winCodeSign", "2.3.2", "brAICKFcwBa+5eFkq+V5JJTt1XxiQNgHwW+ahUupAl2ciAAVikgpUmN7tsdQXjifCRwK2eS3zbE6lcP5y/KRIw==");
}
...
function _getCertInfo() {
  _getCertInfo = (0, _bluebirdLst().coroutine)(function* (file, password) {
    ...
    try {
      result = yield (0, _util().executeAppBuilderAsJson)(["certificate-info", "--input", file, "--password", password]);
    } catch (e) {
...
function getToolPath() {
  ...
  _getToolPath = (0, _bluebirdLst().coroutine)(function* () {
    ...
    if (process.platform === "win32") {
      ...
      try {
        if (yield (0, _util().isMacOsSierra)()) {
