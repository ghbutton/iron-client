...
const wineExecutable = new (_lazyVal().Lazy)(
/*#__PURE__*/
(0, _bluebirdLst().coroutine)(function* () {
  ...
  if (isUseSystemWine) {
    ...
    if (semver().gte(osVersion, "10.13.0")) {
      version = "3.0.3-mac-10.13"; // noinspection SpellCheckingInspection
...
function checkWineVersion(_x) {
  return _checkWineVersion.apply(this, arguments);
} function _checkWineVersion() {
  _checkWineVersion = (0, _bluebirdLst().coroutine)(function* (checkPromise) {
