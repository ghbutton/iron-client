  ...
  const ChatsTab = () => {
    return (
      <Stack.Navigator initialRouteName="ChatsScreen">
        ...
        <Stack.Screen name="InvitationScreen" options={{title: "Invitation"}} component={InvitationScreen} />
        <Stack.Screen name="MessagesScreen" options={{title: "Messages"}} component={MessagesScreen} />
        <Stack.Screen name="NewChatScreen" options={{title: "New Chat"}} component={NewChatScreen} />
      </Stack.Navigator>
    );
  };
